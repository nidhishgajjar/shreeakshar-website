          ...
          <div className="py-8 md:py-16">
            ...
            <article className="max-w-sm mx-auto space-y-5 md:max-w-none md:flex md:items-center md:space-y-0 md:space-x-8 lg:space-x-16">
              ...
              <div className="md:w-1/2" data-aos="fade-up">
                <header>
                  <h2 className="h4 md:text-4xl lg:text-5xl font-bricolage mb-3">
      ...
      <section className="bg-slate-50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-8 md:py-16 space-y-16">
            ...
            {/* Latest */}
            <div>
              <h2 className="h3 font-bricolage text-center md:text-left mb-8">Latest</h2>
            ...
            {/* Popular */}
            <div>
              <h2 className="h3 font-bricolage text-center md:text-left mb-8">Popular</h2>
            ...
            {/* Product & News */}
            <div>
              <h2 className="h3 font-bricolage text-center md:text-left mb-8">Product &amp; News</h2>
